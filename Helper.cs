    ...
    public static class ObjectType
    {
        ...
        public static byte[] GetBytes<T>(T Value)
        {
            ...
            switch (typename)
            {
                ...
                case "System.Byte":
                    return BitConverter.GetBytes((short)Convert.ChangeType(Value, typeof(byte)));
                case "System.String":
...
namespace ProcessUtils
{
    ...
    public static class BinaryTypeExtensions
    {
        ...
        public static bool Is64(this string ApplicationName)
        {
            BinaryType bt;
            if (GetBinaryType(ApplicationName, out bt))
            {
